...
const MyWaletView = ({
  ...
  const displayWalletType = (type) => {
     switch (type) {
        ...
        case "E-Money": return "Dompet Digital";
        ...
        <div className="flex-1 bg-[#F3F4F7] p-7 overflow-auto">
          <div className="flex flex-row justify-between mb-5">
            ...
            <button
              ...
              className={`px-4 bg-blue-600 text-white rounded-[16px] font-semibold flex items-center space-x-2 hover:bg-blue-700 disabled:opacity-50 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={isLoading}
            >
          ...
          {isLoading && wallets.length === 0 ? (
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                {wallets.length === 0 && !isLoading ? (
                     <p className="col-span-full text-center text-gray-500">Belum ada dompet.</p>
                ) : (
                   wallets.map((wallet) => (
                    <div
                        key={wallet.id} 
                    ...
                    >
                        ...
                        <CardWallet size="small" amount={wallet.amount} name={wallet.wallet_name} type={displayWalletType(wallet.wallet_type)} />
                        </div>
      ...
      <Modal
        ...
        >
         <>
            ...
            <div className="mb-4">
                <label htmlFor="wallet_type" className="block text-sm font-medium text-gray-700 mb-1">
                </label>
                <select
                id="wallet_type"
                name="wallet_type" 
