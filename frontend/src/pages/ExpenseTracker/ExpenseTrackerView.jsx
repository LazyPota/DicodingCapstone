    ...
    <div className="flex-1 bg-[#F3F4F7] p-7 overflow-auto">
      <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:justify-between md:items-center mb-5">
        ...
        <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-4 w-full md:w-auto">
          ...
          />
          <button
            className={`px-4 space-x-2 h-[40px] md:h-auto bg-blue-600 text-white rounded-[16px] font-semibold flex items-center justify-center hover:bg-blue-700 disabled:opacity-50 ${
