        ...
        <div className="flex-1 bg-[#F3F4F7] p-7 overflow-auto">
          <div className="flex justify-between mb-5">
            ...
            <div className="flex space-x-4">
              ...
              />
              <button
                className="px-4 space-x-2 bg-blue-600 text-white rounded-[16px] font-semibold flex items-center"
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="text-[14px] bg-white">
              {transactionsToDisplay.map((transaction, index) => {
                ...
                const formattedAmount = Math.abs(transaction.amount).toLocaleString("id-ID");
                ...
                return (
                  ...
                  >
                    <td className="py-3 px-4 text-gray-600">{transaction.no}</td>
                    <td className="py-3 px-4 text-gray-800">{transaction.wallet.wallet_name}</td>
                    <td className="py-3 px-4">
                      <div className="flex space-x-3 items-center">
                        <span className={`${iconBg} text-white w-[37px] h-[37px] flex justify-center items-center rounded-full text-[21px]`}>
                          <Icon icon={iconName} />
                        </span>
                        <span className="text-gray-800">{transaction.category.category_name}</span>
                      </div>
                    </td>
