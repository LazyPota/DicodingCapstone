    ...
    <main className="relative flex min-h-[140vh] p-2">
      ...
      <section className="flex flex-1 justify-center items-center w-full md:w-1/2 lg:w-1/2 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-[400px]">
          <h1 className="text-3xl md:text-[40px] font-bold font-inter text-center lg:text-left">Daftar</h1>
          ...
          <form className="mt-3 flex flex-col space-y-[20px]" onSubmit={handleSubmit} noValidate>
            {/* Input Nama */}
            <div className="relative">
              <input
                ...
                className={`block px-2.5 pb-2.5 pt-4 w-full h-[59px] text-sm text-gray-900 bg-transparent rounded-[10px] border ${
                  errors.name ? "border-red-500 focus:border-red-500" : "border-[#D9D9D9]"
              ...
              <label
                htmlFor="name"
                className={`absolute text-[18px] font-medium font-inter duration-300 transform z-10 origin-[0] bg-white px-2 start-1
                  ${errors.name ? "-translate-y-4 scale-75 top-2" : "peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 -translate-y-4 scale-75 top-2"}
                  peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:px-2 peer-focus:text-[14px]
                  ${errors.name ? "text-red-600 peer-focus:text-red-600" : "text-gray-500 peer-focus:text-blue-600"}
                `}
              >
                Nama Lengkap
              </label>
            ...
            <div className="relative">
              <input
                ...
                name="email"
                className={`block px-2.5 pb-2.5 pt-4 w-full h-[59px] text-sm text-gray-900 bg-transparent rounded-[10px] border ${
                  errors.email ? "border-red-500 focus:border-red-500" : "border-[#D9D9D9]"
              ...
              <label
                htmlFor="email"
                className={`absolute text-[18px] font-medium font-inter duration-300 transform z-10 origin-[0] bg-white px-2 start-1
                  ${errors.email ? "-translate-y-4 scale-75 top-2" : "peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 -translate-y-4 scale-75 top-2"}
                  peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:px-2 peer-focus:text-[14px]
                  ${errors.email ? "text-red-600 peer-focus:text-red-600" : "text-gray-500 peer-focus:text-blue-600"}
                `}
              >
                Email
              </label>
            ...
            <div className="relative">
              <input
                ...
                name="password"
                className={`block px-2.5 pb-2.5 pt-4 w-full h-[59px] text-sm text-gray-900 bg-transparent rounded-[10px] border ${
                  errors.password ? "border-red-500 focus:border-red-500" : "border-[#D9D9D9]"
                } appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer pr-10`}
                placeholder=" "
                value={password}
              ...
              <label
                htmlFor="password"
                className={`absolute text-[18px] font-medium font-inter duration-300 transform z-10 origin-[0] bg-white px-2 start-1
                  ${errors.password ? "-translate-y-4 scale-75 top-2" : "peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 -translate-y-4 scale-75 top-2"}
                  peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 peer-focus:px-2 peer-focus:text-[14px]
                  ${errors.password ? "text-red-600 peer-focus:text-red-600" : "text-gray-500 peer-focus:text-blue-600"}
                `}
              >
                Password
              </label>
          ...
          <p className="text-gray-500 text-[16px] font-medium font-inter text-center mt-[32px]">
            Sudah Punya Akun?{" "}
            <a href="/login" className="text-blue-600 font-semibold font-inter underline hover:text-blue-800">
              Masuk
            </a>
          </p>
        </div>
